...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://rm-bp1846qgesu07h94peo.mysql.rds.aliyuncs.com/courseimooc?characterEncoding=UTF8&autoReconnect=true&serverTimezone=Asia/Shanghai&allowMultiQueries=true";
            String user = "courseimooc";
            String pass = "bdqnzjzq@1987716";
